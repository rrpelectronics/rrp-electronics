...
const Contact = () => {
  return (
    <section className="@container h-fit w-full pt-[140px] pb-10 px-3.5 md:px-5 lg:px-10 grid grid-cols-4 gap-x-3 md:gap-x-5">
      <div className="flex flex-col gap-8 col-span-4 @6xl:col-span-2 mb-10">
        <h3 className="text-display text-black tracking-display leading-[105%]">
