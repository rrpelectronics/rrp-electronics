...
const Impact = () => {
  return (
    <section className="h-fit w-full grid grid-cols-4 gap-x-3 md:gap-x-5 px-3.5 md:px-5 lg:px-10 py-10 md:py-15 bg-whiteBg">
      ...
      <ul className="col-span-4 grid grid-cols-4">
        <li className="col-span-4 grid grid-cols-subgrid gap-x-3 md:gap-x-5 py-5 md:py-6 border-y-1 border-y-borderPrimary">
          <p className="col-span-1 text-primary text-heading4 leading-[115%]">
            01
          </p>
          <p className="mt-3.5 col-span-4 lg:col-span-2 text-black text-heading4 leading-[115%]">
            Strengthening India's Semiconductor <br /> Ecosystem
          </p>
          <p className="col-span-4 md:w-[90%] mt-4 md:mt-6 lg:mt-0 lg:col-span-1 2xl:w-[96%] text-bodySmall text-textPrimary leading-[120%] font-neueMontreal">
