...
const People = () => {
  return (
    <section className="h-fit w-full py-10 md:py-15 bg-background">
      ...
      />
      <div className="grid grid-cols-12 px-3.5 md:px-5 lg:px-10">
        <div className="col-span-12 md:col-span-4 w-full aspect-square relative p-5 lg:p-6 flex flex-col justify-between bg-darkBg">
          <p className="text-heading4 leading-[115%] text-white">
            Our Core Values
          </p>
          <p className="text-bodySmall font-neueMontreal text-textSecondary leading-[120%]">
        ...
        <div className="col-span-12 md:col-span-4 w-full aspect-square relative overflow-hidden">
          ...
          />
          <div className="absolute top-0 left-0 z-2 p-5 lg:p-6 bg-black/70 h-full flex flex-col justify-between">
            <p className="text-heading4 leading-[115%] text-white">
              Our Core Values
            </p>
            <p className="text-bodySmall font-neueMontreal text-white leading-[120%]">
              Sustainability, Innovation, Integrity & Customer Focus — these
              values guide every aspect of how we operate and grow.
            </p>
          </div>
