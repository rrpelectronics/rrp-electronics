...
const imgLayoutData = [
  {
    ...
    title: "Who We Are",
    description:
      "RRP Electronics is Maharashtra’s first OSAT-focused semiconductor company, leading innovation with a commitment to precision,sustainability, and excellence. We’re shaping India’s semiconductor future with world-class technology and trusted expertise.",
  },
  {
...
const page = () => {
  ...
  useEffect(() => {
    setFooterContent({
      ...
      description:
        "Interested in partnering with RRP Electronics? We’d love to connect.",
  ...
  return (
    <main className="min-h-screen w-full overflow-clip relative">
      ...
      <Text
        text={
          "At RRP Electronics, we specialize in advanced OSAT (Outsourced Semiconductor Assembly and Test) services, combining cutting-edge technology with unwavering precision. From concept to completion, we drive innovation that powers next-gen electronics and shapes a smarter, connected future."
        }
      />
