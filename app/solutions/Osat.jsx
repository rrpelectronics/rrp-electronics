    ...
    >
      <div className="col-span-2 flex flex-col justify-between">
        ...
        >
          ...
          >
            We’re proud to launch Maharashtra’s first dedicated OSAT facility a
            major leap forward in India’s semiconductor ecosystem. Designed for
            agility, precision, and scale, our OSAT services support high-volume
            assembly and testing for consumer, industrial, and defense
            applications.
          </p>
        </div>
