...
export default function OSAT() {
  ...
  const renderCardItems = (items) =>
    items.map((item, idx) => (
      <div
        key={idx}
        className="flex items-center gap-2 py-4 md:py-5 border-b border-[#E4E4E4]"
      >
        <Image
    ...
    <section className="w-full h-full bg-white flex flex-col md:grid md:grid-cols-4 gap-5 px-3.5 md:px-10 py-10 md:py-16">
        ...
        <div className="col-span-2 flex flex-col justify-between">
          <div className="flex flex-col gap-4 pb-20 md:pb-0 justify-between">
            <h2 className="text-heading2 tracking-tight font-neueMontrealMd text-black leading-[110%]">
             OSAT (Outsourced Semiconductor Assembly and Test)
            </h2>
            <p className="text-textPrimary font-neueMontreal text-bodyBase leading-[120%]">
