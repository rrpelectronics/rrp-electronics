...
export default function Certifications() {
  ...
  const certifications = [
    ...
    },
    {
      ...
      description: "Registration, Evaluation, Authorization & Restriction of Chemicals",
      image: "images/compliances/trial.png"
    }
  ];
  ...
  return (
    <>
      <section className={`h-fit w-full py-10 md:py-15 bg-white relative ${isPopupOpen ? 'overflow-hidden' : ''}`}>
        <div className={`${isPopupOpen ? 'blur-md' : ''} transition-all duration-500`}>
          <SectionHeader
          ...
          >
            {certifications.map((cert, index) => (
              <div 
                key={index}
                className="col-span-4 md:col-span-2 aspect-[590/290] w-full p-4 flex flex-col justify-between bg-whiteBg cursor-pointer hover:shadow-lg transition-shadow duration-300"
      ...
      {isPopupOpen && (
        ...
        >
          ...
          <div 
            className="relative bg-none overflow-hidden"
            style={{
          ...
          >
            ...
            {/* Option 1: Using an SVG from your gallery */}


            {/* Option 2: Alternative with different styling */}
            {/* <button
              onClick={closePopup}
              className="absolute top-4 right-4 z-10 text-white bg-red-500 hover:bg-red-600 w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-200"
