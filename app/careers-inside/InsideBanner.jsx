...
const InsideBanner = () => {
  return (
    <section className='w-full h-screen px-3.5 md:px-5 lg:px-10 flex flex-col items-start justify-center'>
       <div className='flex flex-col gap-4 md:gap-10'>
        <p className='text-bodyLarge leading-[120%] text-textPrimary'>
          Engineering / Full Time
        </p>
        <h3 className='text-display text-black leading-[110%] tracking-display'>
          Semiconductor<br/>
          Packaging Engineers
        </h3>
         <Link
