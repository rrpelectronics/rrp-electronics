export const JOB_DATA = [
  {
    ...
    description: "We are looking for enthusiastic Diploma holders in Electronics Engineering to join our team. This is an excellent opportunity for freshers and trainees who want to build a career in the semiconductor and electronics domain.",
    experienceMin: null,
    experienceMax: null,
    fresherAllowed: true,
    extraPoints: []
  },
  {
    ...
    type: "Full Time",
    location: "Mahape, Navi Mumbai",
    description: "If you are passionate about managing the flow of materials and resources, we have multiple openings in our Supply Chain Management team across functions such as Purchase, Logistics, Store, and SCM operations.",
    experienceMin: 2,
    experienceMax: 3,
    fresherAllowed: true,
    extraPoints: [
      "Strong analytical, organizational, and communication skills will be an advantage."
    ]
  },
  {
    id: 2,
