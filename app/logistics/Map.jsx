...
const Map = () => {
  const [activeConnectivity, setActiveConnectivity] = useState("Air Connectivity");
  ...
  return (
    <section className="h-ft w-full py-10 md:py-15">
      <SectionHeader
            ...
            >
              ...
              {openMobileItem === connectivity && (
                <div className="block sm:hidden mt-6">
                  <div className="h-[50vh] w-full mx-auto relative mb-4">
                    <Image
